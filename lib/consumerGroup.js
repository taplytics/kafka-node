...
function ConsumerGroup (memberOptions, topics) {
  ...
  this.lastHeartbeatGenerationId = null;
  this.ready = false;
  this.topicPayloads = [];
  this.payloadMap = {};
}
...
ConsumerGroup.prototype.connect = function () {
  ...
  if (this.lastHeartbeatGenerationId !== this.generationId) {
    logger.warn('Connect ignored. Heartbeat generationId is stale.');
    return;
  }
...
ConsumerGroup.prototype.sendHeartbeat = function () {
  ...
  this.lastHeartbeatGenerationId = this.generationId;
